...
$sql = "SELECT * FROM `the-library` WHERE `publisher_name` = 'William Shakespeare' ";
            ...
            <div class='row g-0'>
                ...
                <div class='col-md-8'>
                    ...
                    <div class='card-body p-2'>
                        ...
                        <p class='card-text'><b> Description : </b> <a class='btn btn-success' href='details.php?id=2'>Show Detalis</a></p>
                        <p class='card-text'></p>
                    </div>
                    <div class='card-footer text-center'>
                        <a class='btn btn-primary' href='update.php?id=2'>Edit</a>
                        <a class='btn btn-danger' href='action/a_delete.php?id=2'>Delete</a>
