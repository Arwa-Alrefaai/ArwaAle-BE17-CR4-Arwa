...
$sql = "SELECT * FROM `the-library` WHERE `publisher_name` = 'Thomas Hardy' ";
        ...
        <div class='card mb-3'>
            <div class='row g-0'>
                ...
                <div class='col-md-8'>
                    ...
                    <div class='card-footer text-center'>
                        <a class='btn btn-primary' href='update.php?id=5'>Edit</a>
                        <a class='btn btn-danger' href='action/a_delete.php?id=5'>Delete</a>
